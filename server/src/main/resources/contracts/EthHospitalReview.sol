...
//     function addReview(string memory _facilityId, uint _reviewId, string memory _patientNRIC, uint8  _overallRating, bytes16 _hashedMessage) public returns(uint index){
