...
public class UserController {
    ...
    @PostMapping(path = "/register/healthcareprovider", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> saveHealthcareProvider(@RequestBody User user){
